...
async function run() {
  try {
    ...
    const reviewCollection = await client.db("ryans-pc").collection("reviews");
    const profileCollection = await client.db("ryans-pc").collection("profile");
